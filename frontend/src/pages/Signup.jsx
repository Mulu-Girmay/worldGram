      ...
      <div className="w-full max-w-[480px] rounded-2xl border border-[#6fa63a]/25 bg-[#f3f9ee] p-6 shadow-[0_10px_30px_rgba(74,127,74,0.15)]">
        ...
        <form className="grid gap-4 rounded-xl bg-[#6fa63a]/10 p-4">
          <div className="grid gap-1.5">
            <label className="text-[13px] font-semibold text-[rgba(23,3,3,0.8)]" htmlFor="fname">
              First Name
            </label>
            <input
          ...
          <div className="grid gap-1.5">
            <label className="text-[13px] font-semibold text-[rgba(23,3,3,0.8)]" htmlFor="lname">
              Last Name
            </label>
            <input
              className="rounded-[10px] border border-[#6fa63a]/35 bg-white px-3 py-2 outline-none"
          ...
          <div className="grid gap-1.5">
            <label className="text-[13px] font-semibold text-[rgba(23,3,3,0.8)]" htmlFor="username">
              User Name
            </label>
            <input
              className="rounded-[10px] border border-[#6fa63a]/35 bg-white px-3 py-2 outline-none"
          ...
          <div className="grid gap-1.5">
            <label className="text-[13px] font-semibold text-[rgba(23,3,3,0.8)]" htmlFor="phone">
              Phone Number
            </label>
            <input
              className="rounded-[10px] border border-[#6fa63a]/35 bg-white px-3 py-2 outline-none"
          ...
          <div className="grid gap-1.5">
            <label className="text-[13px] font-semibold text-[rgba(23,3,3,0.8)]" htmlFor="pass">
              Password
            </label>
            <input
              className="rounded-[10px] border border-[#6fa63a]/35 bg-white px-3 py-2 outline-none"
